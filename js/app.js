...
// Declaring player1 and player 2
    ...
    // make sure to maintain your spacing and indentations! It makes your code easier
    // for you to read and check for errors.
    var pl1 = [];
    var pl2 = [];
    var dogWin = 0;
    var catWin = 0;
    ...
    // what is px()? Not a good name!
    $('.box').one('click',function px(){

        if (checkWin()){
            console.log();
        } else if(currentTurn == 0){
            // Careful with syntax below, double 'img' tag
    ...
    // Great job on this! Good approach
    // win condition
    var winConditions = [
    ['1','2','3'],
    ['4','5','6'],
